...
- `GITHUB_TOKEN` - Used for fetching user IDs and team membership to your org's
  `GITHUB_TEAM_ADMINS`
...
4. To use the admin APIs with your GitHub PAT, create `api-admins` team on your
   organization. (or reuse a existing team) and use the team slug as value for
   `GITHUB_ORG_TEAM_ADMINS`.
